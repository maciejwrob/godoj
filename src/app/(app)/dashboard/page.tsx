      ...
      <div className="mx-auto max-w-6xl space-y-8">
            ...
            <div className="bg-surface-container-low rounded-[2rem] overflow-hidden border border-white/5">
              {lessons.length === 0 ? (
                <div className="flex flex-col items-center p-12 text-center">
                  ...
                  <p className="font-semibold text-on-surface">{t("noLessons")}</p>
                  <p className="mt-1 text-sm text-on-surface-variant">{t("startFirstConversation")}</p>
                </div>
              ) : (
                <>
        ...
        <footer className="pt-12 mt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between text-slate-500 text-sm gap-4">
          <div className="flex items-center gap-8 font-medium">
            <span className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">history</span>{totalMinutes} {t("minutesTotal")}</span>
            <span className="flex items-center gap-2"><span className="material-symbols-outlined text-xs">menu_book</span>{vocabCount} {t("words")}</span>
          </div>
        </footer>
      </div>
