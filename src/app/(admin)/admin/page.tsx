...
import { Users, BookOpen, Clock, Mic, AlertTriangle, Mail, Shield, CreditCard } from "lucide-react";
    ...
    <div className="p-8 space-y-8">
      ...
      <div className="bg-bg-card border border-border rounded-xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-lg font-semibold text-text-primary">Problemy z magic linkami (24h)</h2>
        </div>
      ...
      {/* Quick link to full user management */}
      <div className="bg-bg-card border border-border rounded-xl p-5">
        ...
        <p className="text-text-secondary text-sm mt-2">
          {data.userSubscriptions.length} użytkowników zarejestrowanych
        </p>
      </div>
    </div>
  );
