...
export function LanguageProvider({
  ...
  const value: LanguageCtx = {
    ...
    language: activeProfile?.target_language ?? "no",
    languageName: getLangName(activeProfile?.target_language ?? "no"),
    flag: getLangFlag(activeProfile?.target_language ?? "no", activeProfile?.language_variant),
